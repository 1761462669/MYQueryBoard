...
function GetWorkorderInfo() {
    app.DataRequest('QueryCutWorkOrder', { id: id }, function (data) {
        if (data) {
            $("#woinfo").empty();
...
function GetOutSoilInfo() {
    app.DataRequest('GetMaterialTransferinoutsilo', { id: id, typeid: 684275 }, function (data) {
        if (data) {
...
function GetInSoilInfo() {
    app.DataRequest('GetMaterialTransferinoutsilo', { id: id, typeid: 684174 }, function (data) {
        if (data) {
...
function GetCutWorkorderConsume() {
    app.DataRequest('GetCutWorkorderConsume', { id: id }, function (data) {
        if (data) {
...
function GetCutAncestryKeyParamData() {
    var index = 0;
    app.DataRequest('GetCutAncestryKeyParamData', { id: id }, function (data) {
...
function GetQLScore() {
    ...
    app.DataRequest('GetCutBatchSorce', { woid: id }, function (data) {
        if (data) {
    ...
    app.DataRequest('GetProductMonthCutBatchSorce', { woid: id }, function (data) {
        if (data) {
    ...
    app.DataRequest('GetAllProductMonthCutBatchSorce', { woid: id }, function (data) {
        if (data) {
...
function GetAllWorkorderPramQL()
{
    ...
    app.DataRequest('GetAllWorkorderPramQL', { woid: id }, function (data) {
        if (!data)
            return;

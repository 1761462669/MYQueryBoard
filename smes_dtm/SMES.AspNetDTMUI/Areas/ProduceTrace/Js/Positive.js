...
function QueryCutBatchInfo() {
    ...
    var date = $("#date").val();
    var key = $("#txtkey").val();
    app.DataRequest('QueryCutBatchInfo', { plandate: date, productkey: key }, function (data) {
...
function woinfo(batch) {
    //debugger;
    app.DataRequest('QueryWorkOrderOutPut', { batchid: batch.ID }, function (data) {
        ...
        $(".infobtn").click(function () {
            ...
            //debugger;
            var url = 'ProduceProcessInfo' + "?ID=" + wo.WORKORDERID + "&batchid=" + wo.BATCHID;
        ...
        $(".tld").click(function () {
            ...
            //setScroll3
            app.DataRequest('GetCutWorkorderConsume', { id: wo.WORKORDERID }, function (data) {

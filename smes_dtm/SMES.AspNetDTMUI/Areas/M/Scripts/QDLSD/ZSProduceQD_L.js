...
function showTime() {
    ...
    $("#datetimes").html(curTime.toLocaleString());
...
function GetDayWoStatics()
{
    ...
    var productdate = d.getFullYear() + "-" + (d.getMonth() + 1) + "-" + d.getDate();
    productdate += " 00:00:00";
    var tips =  new Date().getFullYear() + '-' + (new Date().getMonth() + 1) + '-' + new Date().getDate() + ' 14:00:00';
    tips = '数据时间：' + productdate + ' 至 ' + tips;

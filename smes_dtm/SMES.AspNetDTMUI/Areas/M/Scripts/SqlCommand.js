...
var SqlCmd=({
    QueryDatasByCd:function(sqlcd,pars,succeed, fail, async)
    {            
        var url="/Public/DatabaseAccess/QueryDatasByCd";

        app.DataRequest(url,{code:sqlcd,paralist:pars},succeed,fail,async);
    }
})
